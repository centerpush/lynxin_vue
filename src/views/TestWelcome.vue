              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <form id="register-form" role="form" style="display: block;">
                    ...
                    <div class="form-group">
                      <input type="password" name="password" id="password" tabindex="2" class="form-control" placeholder="Pawsword">
                    </div>
                    <div class="form-group">
                      <input type="password" name="confirm-password" id="confirm-password" tabindex="2" class="form-control" placeholder="Confirm Pawsword">
                    </div>
                    <div class="form-group">
                      <div class="row">
